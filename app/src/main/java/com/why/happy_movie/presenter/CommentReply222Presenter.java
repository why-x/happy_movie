...
public class CommentReply222Presenter extends BasePresenter {

    public CommentReply222Presenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.commentReply((int)args[0],(String)args[1],(int)args[2],(String) args[3]);
    }
