...
public class MovieDPresenter extends BasePresenter {

    public MovieDPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.findMoviesById((int)args[0],(String)args[1],(int)args[2]);
    }
