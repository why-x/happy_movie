...
public class CinemaCommertPresenter extends BasePresenter {

    public CinemaCommertPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.findAllCinemaComment((int)args[0],(String)args[1],(int)args[2],(int)args[3],(int)args[4]);
    }
