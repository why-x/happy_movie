...
查询影片评论
 */
public class MyCommentAdapter2 extends RecyclerView.Adapter<MyCommentAdapter2.MyHolder> {

    Context context;
    Great12 great12;

    public MyCommentAdapter2(Context context) {
    ...
    List<CinemaCommert> list=new ArrayList<>();
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int i) {
        final CinemaCommert myComment = list.get(i);
    ...
    public void addAll(List<CinemaCommert> result) {
        if (result!=null){
            list.addAll(result);
        }
    }
